 ...
 */
package com.skpd.pixeldungeonskills.items.armor.glyphs;
...
import com.skpd.pixeldungeonskills.items.armor.Armor.Glyph;
		...
		public boolean act() {
			if (target.isAlive()) {
				...
				if (target == Dungeon.hero && !target.isAlive()) {
					// FIXME
					Dungeon.fail( Utils.format( Res.GLYPH, "enchantment of viscosity", Dungeon.depth ) );
